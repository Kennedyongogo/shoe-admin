...
const Contacts = ({ embedded = false }) => {
  ...
  const handleDelete = async (contact) => {
    const result = await Swal.fire({
      ...
      text: `Inquiry from "${contact.fullName}" will be removed.`,
      icon: "warning",
    ...
    try {
      ...
      await Swal.fire({
        icon: "success",
        title: "Deleted",
        text: "Contact inquiry removed successfully.",
        timer: 1400,
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={8} align="center" sx={{ py: 4 }}>
                      <Typography color="text.secondary">No contact inquiries found.</Typography>
                    </TableCell>
                  </TableRow>
                ) : (
                  contacts.map((contact, idx) => (
                    <TableRow key={contact.id} hover>
                      ...
                      <TableCell sx={{ maxWidth: 160 }}>
                        <Typography variant="body2" noWrap title={contact.email}>
                          {contact.email}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">{contact.serviceType || "—"}</Typography>
                      </TableCell>
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ opacity: 0.9 }}>
            Messages submitted by public users (Contact Us form)
          </Typography>
        </Box>
        {content}
      </Paper>
